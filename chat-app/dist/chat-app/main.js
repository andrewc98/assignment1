...
var ChatComponent = /** @class */ (function () {
    ...
    ChatComponent.prototype.ngOnInit = function () {
        ...
        this.connection = this.sockServer.getMessage().subscribe(function (message) {
            _this.messages.push(message);
            _this.message = '';
        });
    };
    ChatComponent.prototype.sendMessage = function () {
        var data = '[' + this.username + ']' + this.message;
...
module.exports = __webpack_require__(/*! C:\Assignment - 1\chat-app\src\main.ts */"./src/main.ts");
